                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="5%">image</th>
                                    @if (Auth::guard('admin')->user()->can('sale.delete') || Auth::guard('admin')->user()->can('sale.edit'))
                                ...
                                <tr>
                                    ...
                                    <td> <img src="{{ asset('storage/app/public/uploads/sale/'.$ware->document) }}"
                                        ...
                                        <ul class="d-flex justify-content-center">
                                            ...
                                            @if (Auth::guard('admin')->user()->can('sale.edit'))

                                            <li class="mr-3"><a type="button"
                                                    href="{{route('admin.sale.update',$ware->id)}}"><i
...
@endif
                                            <form method="get" action="{{ route('admin.brand.delete', $ware->id) }}">
                                                ...
                                                <a type="submit" class=" text-danger btn-flat show_confirm"
                                                    data-toggle="tooltip" title='Delete'><i class="ti-trash"></i></a>
                                            @endif
                                                </form>
                                        </ul>
                                    </td>
...
<div class="modal fade bd-example-modal-lg" style="display: none;" aria-hidden="true">
                                ...
                                <table class="table">
                                    ...
                                    <tbody id="purchaseTable">
                                        <tr>
                                            ...
                                            <td><input type="hidden" class="form-control name" name="name[]"
                                                    placeholder="Name">
                                            </td>
                                            {{-- <td><input type="text" class="form-control code" name="code[]"
                                                    placeholder="code">
                                            </td> --}}
                                            <td><input type="hidden" class="form-control latestqty qty" name="qty[]"
                                                    placeholder="0.00">
  ...
  border-radius: 0px;" type="button" id="as" class="btn btn-success btn-sm"><i
                                                ...
                                                placeholder="0.00"></td> -->
                                            <td><input type="hidden" class="form-control subtot" name="product_subtot[]"
                                                    placeholder="0.00"></td>
                        ...
                        <table class="table mt-4 table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <input type="text" class="all_total" name="sub_total">
